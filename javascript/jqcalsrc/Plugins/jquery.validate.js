(function(jQuery) {
    ...
    jQuery.extend(jQuery.validator, {
        ...
        messages: {
            ...
            maxlength: jQuery.format("At most {0} characters required"),
            minlength: jQuery.format("At least {0} characters required"),
            rangelength: jQuery.format("Please enter {0} to {1} character(s)"),
            range: jQuery.format("Please enter a number between {0} and {1}"),
            max: jQuery.format("Please enter a number less than {0}"),
            min: jQuery.format("Please enter a number great than {0}")
        },
        ...
        prototype: {
            ...
            check: function(element) {
                ...
                for (method in rules) {
                    ...
                    try {
                        var result = jQuery.validator.methods[method].call(this, element.value, element, rule.parameters);
