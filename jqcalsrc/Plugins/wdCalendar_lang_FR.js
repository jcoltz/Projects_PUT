var i18n = jQuery.extend({}, i18n || {}, { //edits from original by Jim Coltz 2011-12-09
    xgcalendar: {
        ...
        "invalid_title": "Titre de l'\u00C9v\u00E9nement ne peut pas etre vierge ou contenir ($,<,>)",
		...
		// use ResourceNameTitle argument in component builder 
		"showcustombtnp" : "Les ", //Custom Button prefix Text - will have number of days appended to it followed by showcustombtns.
		"showcustombtns" : " jours suivants", //Custom Button suffix text
		"showcustombtn_title" : "Affichage personnalis\u00E9", //Custom Button title text      
		...
		"alert_groupname":"Nom de la ressource",		
		...
		"showicalexport" : "Export iCal", // Ical Export button text.
		"showicalbtn_title" : "Exporter le fichier iCal", // Ical Export button's title text.
		"msgbox_nothingtoexport": "D\u00E9sol\u00E9, il n'y a pas d'\u00E9v\u00E9nement dans la plage de dates s\u00E9lectionn\u00E9e pour que l'!", //ical export error message
		"msgbox_dateerror":"La date de d\u00E9part doit \u00EAtre inf\u00E9rieure ou \u00E9gale \u00E0 la date de fin ou laiss\u00E9e en blanc.", //ical export error message	
		"msgbox_dateformaterror" : "Erreur de format de date. Les dates doivent \u00EAtre au format yyyy-MM-dd ou vide."
