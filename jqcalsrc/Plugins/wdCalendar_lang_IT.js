var i18n = jQuery.extend({}, i18n || {}, { //edits from original by Jim Coltz 2011-12-09
    xgcalendar: {
        ...
        "invalid_title": "Titolo dell'evento non pu\u00F2 essere vuota o contenere ($<,>)",
		...
		// use ResourceNameTitle argument in component builder 
		"showcustombtnp" : "Prossimi ", //Custom Button prefix Text - will have number of days appended to it followed by showcustombtns.
		"showcustombtns" : " giorni", //Custom Button suffix text
		"showcustombtn_title" : "visualizzazione personalizzata", //Custom Button title text 
		...
		"alert_groupname":"Nome risorsa",		
		//below used for pop up for deletes from the calendar.
        "confirm_delete_event": "Sei sicuro di voler cancellare questo evento?",
        "confirm_delete_event_or_all": "Questo evento fa parte di una serie ricorrente di eventi. Si prega di scegliere gli eventi da eliminare.",
		"msgbox_title":"Elimina evento",
		"msgbox_onlythisevent":"Solo questo evento.",
		"msgbox_allevents":"Tutti gli eventi della serie.",
		"msgbox_thisandallfuture":"Questo e tutti gli eventi futuri della serie.",
		//below for iCal export
		"showicalexport" : "iCal esportazione", // Ical Export button text.
		"showicalbtn_title" : "Esporta file iCal", // Ical Export button's title text.
		"msgbox_nothingtoexport": "Spiacenti, non ci sono eventi nell'intervallo di date selezionato per l'esportazione!", //ical export error message
		"msgbox_dateerror":"La data iniziale deve essere minore o uguale alla data di fine, o lasciato vuoto.", //ical export error message
		"msgbox_dateformaterror" : "Formato data errore. Le date devono essere in yyyy-MM-dd formato o in bianco."
