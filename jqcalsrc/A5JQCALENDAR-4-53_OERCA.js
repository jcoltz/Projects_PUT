...
//Buddle position		
		function getbuddlepos(x, y) {
			...
			var tleft = x - 110;
			//var ttop = y - 217;
//adjust Y position for extra line of description.			
			var ttop = y - 232;
...
//add in description to div created in buddle var code above.
if(data[11].length > 0){						
	jQuery("#acds_description").html(i18n.xgcalendar.description+": "+data[11]); //modify text to suit. You can add styling here or add a class to the span defined in the buddle code.
}else{
	jQuery("#acds_description").html("&nbsp;"); //blank space to preserve height if the description is blank.
}
						bud.data("cdata", data);
						bud.css({
							"visibility": "visible",
